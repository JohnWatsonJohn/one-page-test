...
@Component({
  selector: 'tst-footer',
  template: `<footer class="page-section bg-gray-lighter footer pb-60">
      <div class="container">
          <!-- Footer Logo -->
          ...
          <div class="footer-social-links mb-110 mb-xs-60">
              <tst-social-links *ngFor="let socialLink of socialLinks"  [socialLinkHref]="socialLink.socialLinkHref" [socialLinkTitle]="socialLink.socialLinkTitle" [socialLinkIcon]="socialLink.socialLinkIcon"></tst-social-links>
          </div>
          <!-- End Social Links -->
          <!-- Footer Text -->
